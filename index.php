						...
						<!-- One -->
							<section id="one" class="tiles">
								<article>
									...
									<header class="major">
										<h3><a href="landing.html" class="link">Hombres</a></h3>
								...
								<article>
									...
									<header class="major">
										<h3><a href="landing.html" class="link">Mujeres</a></h3>
								...
								<article>
									...
									<header class="major">
										<h3><a href="landing.html" class="link">Todo</a></h3>
						...
						<!-- Two -->
							<section id="two">
								<div class="inner">
									...
									<ul class="actions">
										<li><a href="landing.html" class="button next">Sobre nosotros</a></li>
									</ul>
								</div>
							</section>
